...
const Dragons = () => {
  ...
  const [selectedDragon, setSelectedDragon] = React.useState();
  ...
  return (
    <div>
      ...
      <DragonDetail isOpen={isDetailOpen} dragon={selectedDragon} closeModal={() => { handleIsDetailOpen(false) }} dragon={selectedDragon}></DragonDetail>
    </div>
  );
}
